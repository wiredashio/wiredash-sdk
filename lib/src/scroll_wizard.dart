...
class ScrollWizardController extends ScrollController {
  ...
  /// The page to show when first creating the [ScrollWizard].
  ...
  /// The current page displayed in the controlled [ScrollWizard].
  ///
  /// There are circumstances that this [ScrollWizardController] can't know the current
  /// page. Reading [page] will throw an [AssertionError] in the following cases:
  ///
  /// 1. No [ScrollWizard] is currently using this [ScrollWizardController]. Once a
  /// [ScrollWizard] starts using this [ScrollWizardController], the new [page]
  /// position will be derived:
  ///
  ///   * First, based on the attached [ScrollWizard]'s [BuildContext] and the
  ///     position saved at that context's [PageStorage] if [keepPage] is true.
  ///   * Second, from the [ScrollWizardController]'s [initialPage].
  ///
  /// 2. More than one [ScrollWizard] using the same [ScrollWizardController].
  ///
  /// The [hasClients] property can be used to check if a [ScrollWizard] is attached
  ...
  /// Animates the controlled [ScrollWizard] from the current page to the given page.
  ///
  ...
  /// Changes which page is displayed in the controlled [ScrollWizard].
  ///
  ...
  /// Animates the controlled [ScrollWizard] to the next page.
  ///
  /// The animation lasts for the given duration and follows the given curve.
  /// The returned [Future] resolves when the animation completes.
  ///
  ...
  /// Animates the controlled [ScrollWizard] to the previous page.
  ///
  /// The animation lasts for the given duration and follows the given curve.
  /// The returned [Future] resolves when the animation completes.
  ///
...
class PageMetrics extends FixedScrollMetrics {
  ...
  /// The current page displayed in the [ScrollWizard].
  double? get page {
...
/// Scroll physics used by a [ScrollWizard].
///
...
class ScrollWizard extends StatefulWidget {
  ...
  /// [ScrollWizard] will participate in accessibility scrolling more like a
  /// [ListView], where implicit scroll actions will move to the next page
  /// rather than into the contents of the [ScrollWizard].
  /// {@endtemplate}
  ScrollWizard({
    Key? key,
    this.scrollDirection = Axis.horizontal,
    this.reverse = false,
    ScrollWizardController? controller,
    this.physics,
  ...
  ///
  /// Providing a non-null [itemCount] lets the [ScrollWizard] compute the maximum
  /// scroll extent.
  ///
  ...
  /// [ScrollWizard] or [PageView.custom].
  ///
  /// {@macro flutter.widgets.PageView.allowImplicitScrolling}
  ScrollWizard.builder({
    Key? key,
    this.scrollDirection = Axis.horizontal,
    this.reverse = false,
    ScrollWizardController? controller,
  ...
  /// {@tool snippet}
  ///
  /// This [ScrollWizard] uses a custom [SliverChildBuilderDelegate] to support child
  /// reordering.
  ///
  /// ```dart
  ...
  /// view is scrolled.
  final ScrollWizardController controller;
  ...
  ///
  /// If the [padEnds] is false and [ScrollWizardController.viewportFraction] < 1.0,
  ...
  /// A delegate that provides the children for the [ScrollWizard].
  ///
  /// The [PageView.custom] constructor lets you specify this delegate
  /// explicitly. The [ScrollWizard] and [PageView.builder] constructors create a
  ...
  ///
  /// If this is set to true and [ScrollWizardController.viewportFraction] < 1.0, padding will be added
  /// such that the first and last child slivers will be in the center of
  /// the viewport when scrolled all the way to the start or end, respectively.
  ///
  /// If [ScrollWizardController.viewportFraction] >= 1.0, this property has no effect.
  ///
  /// This property defaults to true and must not be null.
  final bool padEnds;

  @override
  State<ScrollWizard> createState() => _ScrollWizardState();
}

class _ScrollWizardState extends State<ScrollWizard> {
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder description) {
    ...
    description.add(DiagnosticsProperty<ScrollWizardController>(
        'controller', widget.controller,
        showName: false));
